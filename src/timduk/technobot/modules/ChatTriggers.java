...
public class ChatTriggers
{
    ...
    public static boolean check(Message msg)
    {
        ...
        String answerHello [] = {"Привет", "Hello", "Hola", "Hallo", "Bonjour", "Вітання", "Salam", "Здраво", "مرحبا", "Dobrý den", "Здрасти", "Прывітанне"};
        ...
        if (checkContent(msg, hello)) {
            ...
            msg.getChannel().sendMessage(answerHello[rand] + " " + msg.getGuild().getEmoteById(477023636021313546L).getAsMention()).queue();
            setTimeoutHello();
            return true;
        }
        // Check mention
        if (msg.getMentionedMembers().contains(msg.getGuild().getMemberById(properties.get().technoBotUserId))) {
