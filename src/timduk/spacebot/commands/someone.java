...
import timduk.spacebot.modules.MemberData;
...
public class someone
{
    public someone(Message msg)
    {
        ...
        while (true)
        {
            ...
            if (randomMember.getRoles().contains(msg.getGuild().getRoleById(properties.get().spaceSomeOneMinRoleId)))
            {
                break;
            }
        }
        ...
        embed.setColor(new Color(76,104,118));
